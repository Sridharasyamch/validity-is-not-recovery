...
result does not depend on web-pretrained recall of test molecules. It transfers
to real generative-model output: 91.5\% of 4{,}009 genuinely invalid strings from
...
scope. Ranking confidence supports abstention: 46\% of inputs can be answered at
96.4\% precision. We release the benchmark, code, and per-item outputs.
\end{abstract}
