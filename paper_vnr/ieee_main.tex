...
\item A decomposition showing \emph{where} recovery comes from: symbolic
      enumeration makes recovery possible (99.79\% candidate coverage); and on
      the fixed pruned candidate set, selection raises exact recovery from
      13.6\% with uniform choice to 80.7\% with the domain language model.
...
The chemical prior makes recovery \emph{accurate}, raising exact recovery on
the same pruned candidate set from 13.6\% with uniform selection to
